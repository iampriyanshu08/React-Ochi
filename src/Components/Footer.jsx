...
const Footer = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".2"  className="h-screen w-full bg-[#F1F1F1] flex  p-20 text-zinc-900 font-['Founders_Grotesk_X']">
      <div className="w-1/2 flex flex-col justify-between   h-[80vh] ">
      ...
      <div className="w-1/2 -400 h-[80vh] font-['Founders_Grotesk_X'] ">
        <h1 className="text-[8vw] uppercase font-semibold leading-none ">
          Presentations
        </h1>
        <div className="footdets font-['Neue_Montreal'] mt-10">
          {["Instagram", "Twitter", "Facebook", "LinkedIn"].map((item, i) => (
            <a className="block text-xl font-light" key={i} href="#">
              {item}
            </a>
          ))}
        </div>
        <div className="footdets font-['Neue_Montreal'] mt-10 flex justify-between underline underline-offset-4">
         <div>
         {[
            "202-1965 W 4th Ave",
            "Vancouver Canada",
